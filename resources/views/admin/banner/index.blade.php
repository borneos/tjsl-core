            ...
            <div class="d-flex">
              <form class="form-inline" method="GET">
                <div class="input-group">
                  ...
                  <input id="filter" name="filter" value="{{$filter}}" autocomplete="off" placeholder="Search Banner" type="text" class="form-control" style="color: gray;">
                  <div class="input-group-prepend">
         ...
         <table style="width: 100%;" class="table table-hover table-striped table-bordered">
            <thead>
               <tr>
                  ...
                  <th>Image</th>
                  <th>@sortablelink('title', 'Banner Title')</th>
                  <th>URL</th>
                  <th>Action</th>
               </tr>
            </thead>
            <tbody>
                @forelse ($banners as $banner)
                    <tr>
                        ...
                        <td>
                           <a href="{{ route('admin.banner.edit',$banner->id) }}" class="btn btn-warning btn-sm" title="Edit ?"><i style="font-size: 14px" class="text-white pe-7s-note"></i></a>
                ...
                @empty
                  <tr>
                    <td colspan="5">No banner to display.</td>
                  </tr>
                @endforelse
            </tbody>
         </table>
          <div class="row">
            ...
            <div class="col-12 col-md-6 w-100 d-flex justify-content-end align-middle">
              <p>Displaying {{$banners->count()}} of {{ number_format($banners->total(), 0, "", ".") }} banner</p>
            </div>
          </div>
      </div>
   </div>
