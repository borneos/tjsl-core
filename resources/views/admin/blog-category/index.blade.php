   ...
   <div class="app-page-title">
      <div class="page-title-wrapper">
         <div class="page-title-heading">
            ...
            <div>Master Blog Category <span class="badge badge-pill badge-primary">{{ number_format($categories->total(), 0, "", ".") }}</span><div class="page-title-subheading">List Master Blog Category</div></div>
         </div>
        ...
        <div class="row mb-3">
         ...
         <table style="width: 100%;" class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                ...
                @empty
                  <tr>
                    <td colspan="6">No blog category to display.</td>
                  </tr>
                @endforelse
            </tbody>
         </table>
          <div class="row">
            ...
            <div class="col-12 col-md-6 w-100 d-flex justify-content-end align-middle">
              <p>Displaying {{$categories->count()}} of {{ number_format($categories->total(), 0, "", ".") }} blog category</p>
            </div>
          </div>
      </div>
   </div>
